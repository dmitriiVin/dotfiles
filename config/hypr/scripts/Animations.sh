#!/usr/bin/env bash
# Выбор и применение анимаций Hyprland
...
msg='Выбранный пресет будет записан в configs/Animations.conf'
...
if [[ -n "$chosen_file" ]]; then
    ...
    notify-send -u low -i "$iDIR/ja.png" "$chosen_file" "Анимация Hyprland применена"
fi
